...
- **`@ConditionalOnProperty(enabled=false)` do jdempotent** (desligamento deliberado, distinto do cenário fail-fast do AD-8) — não pedido nesta rodada; revisitar se surgir um AC específico para esse caminho.
