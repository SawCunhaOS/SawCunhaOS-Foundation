...
/**
 * Local ArchUnit rules (AD-5) that keep {@code scos-foundation-jdempotent-api} from turning into a
 * new {@code utils}: only {@code @interface}/{@code enum}, no runtime dependency beyond the JDK.
 */
@AnalyzeClasses(packages = "br.com.sawcunhaos.foundation.jdempotent.api",
...
class ArchitectureTest {
    ...
    static final ArchRule noRuntimeDependencyBeyondJdk = classes()
            ...
            .resideInAnyPackage("java..", "br.com.sawcunhaos.foundation.jdempotent.api..");
