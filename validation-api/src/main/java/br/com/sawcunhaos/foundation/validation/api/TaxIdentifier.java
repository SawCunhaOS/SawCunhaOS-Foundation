 ...
 * ({@code TaxIdentifierValidator}) lives in {@code scos-foundation-validation}, which depends on
 * this module — referencing it back here would create a module cycle. The binding is restored at
